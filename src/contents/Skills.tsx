import { Container, Divider, Paper, Stack, Table, TableBody, TableContainer, Typography } from "@mui/material"
import { SiCentos, SiCloudflare, SiCplusplus, SiCsharp, SiDocker, SiDotnet, SiFastapi, SiFlask, SiGit, SiHeroku, SiJavascript, SiMacos, SiMysql, SiOracle, SiPostgresql, SiPython, SiReact, SiRedis, SiScikitlearn, SiTypescript, SiUbuntu, SiVercel, SiWindows11 } from '@icons-pack/react-simple-icons';
...
const Skills = () => {
  return (
    <Container disableGutters sx={{marginBlock: "10px"}}>
      <Typography variant="h5" component="h1">Skills</Typography>
          ...
          <Table sx={{ width: "100%", minWidth: "400px" }} size="small">
            <TableBody>
              <TableContent key={"lang"} name={"Language"} data={(
                <Stack direction="row" gap={1} rowGap={.5} justifyContent={"end"} flexWrap={"wrap"}>
